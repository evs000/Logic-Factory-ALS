...
public:
    ...
    ull GET_MEM(ABC_NAMESPACE::Abc_Ntk_t * pNtk1, ABC_NAMESPACE::Abc_Ntk_t * pNtk2);
    ull NtkMiterComp(ABC_NAMESPACE::Abc_Ntk_t * pNtk1, ABC_NAMESPACE::Abc_Ntk_t * pNtk2);
    ull NtkMiterFinalize( ABC_NAMESPACE::Abc_Ntk_t * pNtk1, ABC_NAMESPACE::Abc_Ntk_t * pNtk2, ABC_NAMESPACE::Abc_Ntk_t * pNtkMiter, ll fComb, ll nPartSize, ll fImplic, ll fMulti );
    ABC_NAMESPACE::Abc_Obj_t ** X_subtract_Y_abs(ABC_NAMESPACE::Abc_Ntk_t * pNtk, ABC_NAMESPACE::Abc_Obj_t * X[], ABC_NAMESPACE::Abc_Obj_t * Y[], ll n);
    ull GETMEM(ABC_NAMESPACE::Abc_Ntk_t * pNtk, ABC_NAMESPACE::Abc_Obj_t *R[], ll n);
    ABC_NAMESPACE::Abc_Obj_t * X_lt_Y(ABC_NAMESPACE::Abc_Ntk_t * pNtk, ABC_NAMESPACE::Abc_Obj_t * X[], ABC_NAMESPACE::Abc_Obj_t * Y[], ll n);
    bool SATSolver(ABC_NAMESPACE::Abc_Ntk_t * pNtk);
};
...
public:
    ...
    void BatchErrEstPro(NetMan& accNet, NetMan& appNet, LACMan& lacMan, bool enableFastErrEst);
    ...
    void FindDisjCutOfNode(ABC_NAMESPACE::Abc_Obj_t* pObj, AbcObjList& disjCut);
    void ExpandCut(ABC_NAMESPACE::Abc_Obj_t* pObj, AbcObjList& disjCut);
    ABC_NAMESPACE::Abc_Obj_t* ExpandWhich(AbcObjList& disjCut);
