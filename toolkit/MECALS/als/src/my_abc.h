...
public:
    ...
    inline int GetFanoutId(ABC_NAMESPACE::Abc_Obj_t * pObj, int i) {return GetId(GetFanout(pObj, i));}
    inline int GetFanoutId(int id, int i) {return GetFanoutId(GetObj(id), i);}
