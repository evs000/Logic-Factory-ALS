...
namespace ABC_NAMESPACE {
    int Abc_NtkDSat( Abc_Ntk_t * pNtk, ABC_NAMESPACE::ABC_INT64_T nConfLimit, ABC_NAMESPACE::ABC_INT64_T nInsLimit, int nLearnedStart, int nLearnedDelta, int nLearnedPerce, int fAlignPol, int fAndOuts, int fNewSolver, int fVerbose );
}

namespace mecals{
using ABC_NAMESPACE::Abc_Aig_t;
using ABC_NAMESPACE::Abc_Obj_t;
