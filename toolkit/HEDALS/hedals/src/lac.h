...
public:
    ...
    IntVec GetDivs(ABC_NAMESPACE::Abc_Obj_t * pNode, int nLevDivMax);
    std::string BuildFuncWithEspresso(Simulator & smlt, ABC_NAMESPACE::Abc_Obj_t * pPivot, const IntVec & faninIds);
    void GenCandLacs();
