...
public:
    explicit DALSMan(ABC_NAMESPACE::Abc_Ntk_t * pNtk, unsigned source_seed, int n_frame, int _mode, int use_post_proc, int cut_size_lim, double err_upp_bound, LAC_TYPE lac_type, METR_TYPE metr_type, DISTR_TYPE distr_type, MAP_TYPE map_type);
    ~DALSMan();
