...
public:
    ...
    void FindDisjCut(NetMan & net, std::vector <ABC_NAMESPACE::Abc_Obj_t *> & topoNodes);
    void FindAppDisjCut(NetMan & net);
    void FindDisjCutOfNode(ABC_NAMESPACE::Abc_Obj_t * pObj, std::list <ABC_NAMESPACE::Abc_Obj_t *> & disjCut);
    void ExpandCut(ABC_NAMESPACE::Abc_Obj_t * pObj, std::list <ABC_NAMESPACE::Abc_Obj_t *> & disjCut);
    ABC_NAMESPACE::Abc_Obj_t * ExpandWhich(std::list <ABC_NAMESPACE::Abc_Obj_t *> & disjCut);
